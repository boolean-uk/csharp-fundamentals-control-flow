...
namespace csharp_fundamentals_control_flow.Main
{
    public class Core
    {
        ...
        {
            if (num > 7) { return "Correct!"; } else { return "Wrong!"; };
        ...
        {
            if (!boolean) { return "Correct!"; } else { return "Wrong!"; };
        ...
        {
            if (numOne >= numTwo) { return "Correct!"; } else { return "Wrong!"; };
