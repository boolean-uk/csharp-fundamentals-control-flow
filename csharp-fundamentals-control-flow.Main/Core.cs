...
namespace csharp_fundamentals_control_flow.Main
{
    public class Core
    {
        ...
        {
            // throw new NotImplementedException();
            // Use a conditional statement to check if the array is not empty
        ...
        {
            //throw new NotImplementedException();
            if (sentence.Contains("milk") && sentence.Contains("coffe")) { return 9; }
            else if (sentence.Contains("coffee")) { return 6; }
            else if (sentence.Contains("milk") ) { return 3; }
            else { return 0; }
        }
