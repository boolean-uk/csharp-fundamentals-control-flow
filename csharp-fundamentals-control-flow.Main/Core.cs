...
namespace csharp_fundamentals_control_flow.Main
{
    public class Core
    {
        ...
        public string one()
        {
            // string res = sayGoodMorning(false);
            return "Good day!";
        }
        ...
        public string three()
        {
            // bool res = ("Hello" == "Hello"); // this should return 'true'
        ...
        {
            if (sentence.Contains("milk")) { return true; }
            return false;
        }
        ...
        {
            if (sentence.Contains("coffee") && sentence.Contains("milk")) { return 9; }
            if (sentence.Contains("milk")) { return 3; }
            if (sentence.Contains("coffee")) { return 6; }
            return 0;
        }
        ...
        public string thirteen(int age)
        {
            ...
            if (age > 0 && age < 5) { return "Toddler"; }
            if (age > 4 && age < 13) { return "Child"; }
