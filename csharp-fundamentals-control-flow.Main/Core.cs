...
namespace csharp_fundamentals_control_flow.Main
{
    public class Core
    {
        ...
        public int eleven(string sentence)
        {
            switch (sentence)
            {
                case var expression when sentence.Contains("coffee") && sentence.Contains("milk"):
                    return 9;
                    break;
                case var expression when sentence.Contains("milk"):
                    return 3;
                    break;
                case var expression when sentence.Contains("coffee"):
                    return 6;
                    break;
                default:
                    return 0;
        ...
        public string thirteen(int age)
        {
            switch (age)
            {
                case var expression when age >= 20:
                    return "Adult";
                    break;
                case var expression when age >= 13:
                    return "Teenager";
                    break;
                case var expression when age >= 5:
                    return "Child";
                    break;
                case var expression when age >= 1:
                    return "Toddler";
                    break;
                default:
                    return "Baby";
