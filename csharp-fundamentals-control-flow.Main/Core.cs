...
namespace csharp_fundamentals_control_flow.Main
{
    public class Core
    {
        ...
        public string thirteen(int age)
        {
            ...
            {
                case 0: return "Baby";
                case int when (age >= 1 && age <= 4): return "Toddler";
                case int when (age >= 5 && age <= 12): return "Child";
                case int when (age >= 13 && age <= 19): return "Teenager";
                case int when age >= 20: return "Adult";
            }
            return "";
        }
    }
