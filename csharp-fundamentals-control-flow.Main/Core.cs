...
namespace csharp_fundamentals_control_flow.Main
{
    public class Core
    {
        ...
        {
            if (sentence.ToLower().Contains("milk"))
            {
                return true;
            }
            else
        ...
        {
            if (sentence.ToLower().Contains("milk") && sentence.ToLower().Contains("coffee"))
                return 9;
            else if
                (sentence.ToLower().Contains("coffee"))
                return 6;
            else if
                (sentence.ToLower().Contains("milk"))
                return 3;
            else
                return 0;
