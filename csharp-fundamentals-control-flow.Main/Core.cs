...
namespace csharp_fundamentals_control_flow.Main
{
    public class Core
    {
        ...
        {
            bool containsMilk = sentence.Contains("milk");
            bool containsCoffee = sentence.Contains("coffee");

            if (containsMilk && containsCoffee) return 9;
            else if (containsCoffee) return 6;
            else if (containsMilk) return 3;
            return 0;
        }
